...
private class Final{
	void fun(){
		System.out.println("Inner Classsssssssssss");
	}
}
  public Worker ()
  {
  ...
  public static void main (String[] args) throws InterruptedException
  {
    ...
    System.out.println ("This whole process took: " + difference/1000 + " seconds."+"   "+Thread.currentThread().getName()+"  "+Thread.currentThread().isAlive());
  }
