...
public class ConcurrentModificationExceptionExample {
	...
	public static void main(String args[]) {
		...
		/*
		 * for (String string : myList) { System.out.println("List Value:" + string); if
		 * (string.equals("3")) myList.remove(string);
		 * 
		 * }
		 */
		...
		/*
		 * Map<String, String> myMap = new HashMap<String, String>(); myMap.put("1",
		 * "1"); myMap.put("2", "2"); myMap.put("3", "3");
		 * 
		 ...
		 * if (key.equals("2")) { // myMap.put("1", "4"); myMap.put("4", "4"); } }
		 */
	}
}